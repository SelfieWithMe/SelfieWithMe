...
// Initialize Parse
            ...
            function addphoto(camera,style,tips,writer,img,Photonum){
             ...
             $('.portfolio-modal .img').eq(Photonum).html('<img class="img-responsive img-centered"'+img+'alt=""'>);
             $('.portfolio-item .img').eq(Photonum).html('<img class="img-responsive img-centered"'+img+'alt=""'>);
